...
- **Message Actions**: Long-press/right-click opens WhatsApp-style floating context menu near the message with: Reply, Copy, Translate, Star (coming soon), Pin (coming soon), Edit (own messages only), Delete, Select messages
